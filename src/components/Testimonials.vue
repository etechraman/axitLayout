  ...
  <div class="testimonials">
    ...
    <div class="testimonials--cards">
      <v-row class="pa-0 pa-sm-16 pa-md-16 pa-lg-16 mx-0 mx-sm-0 mx-lg-16">
        <v-col
          class="px-2 px-sm-16 px-md-16 px-lg-16"
          cols="12"
          sm="12"
          md="6"
          lg="4"
        >
          <v-card flat>
            ...
            <v-card-title
              ><v-avatar class="mr-5" size="90"
                ><v-img src="../assets/images/testimonials-avatar.png"></v-img
              ></v-avatar>
              <div class="d-flex flex-column">
                Jeremy H.<v-card-subtitle>Manager</v-card-subtitle>
              </div>
            </v-card-title>
          </v-card>
        </v-col>
